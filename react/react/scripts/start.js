...
// Keep dev build from clearing the console
...
if (!checkRequiredFiles([paths.appHtmlDev, paths.appIndexJs])) {
	process.exit(1);
}
...
checkBrowsers(paths.appPath, isInteractive)
	...
	.then((port) => {
		...
		devServer.listen(port, HOST, (err) => {
			...
			console.log(chalk.cyan(`Starting the ${appName} app on the development server...\n`));

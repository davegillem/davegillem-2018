...
process.env.NODE_PATH = (process.env.NODE_PATH || '') // eslint-disable-line
...
function getClientEnvironment(publicUrl) {
	const raw = Object.keys(process.env) // eslint-disable-line
		...
		.reduce(
			(env, key) => {
				...
				//PUBLIC_URL: (process.env.NODE_ENV === 'development') ? process.env.CI_TENANT : publicUrl
			}
		);

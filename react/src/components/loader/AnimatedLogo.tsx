...
const stroke: string = '#375774'; // '#e7e6e2';
const strokeDasharray: string = '2800 2800';
const strokeDashoffset: number = 50;
const strokeLinecap: 'square' | 'inherit' | 'round' | 'butt' | undefined = 'round';
const strokeMiterlimit: number = 10;
const strokeWidth: number = 2;

export const AnimatedLogo: React.SFC<IAnimatedLogoProps> = (props): React.ReactElement<any> => {
	return (

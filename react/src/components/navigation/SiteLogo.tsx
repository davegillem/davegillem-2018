...
export const SiteLogo: React.SFC<ISiteLogoProps> = (props): React.ReactElement<any> => {
	return (
		<a className="logoHolder" href={props.path} itemScope={true} itemType="http://schema.org/WPHeader">
